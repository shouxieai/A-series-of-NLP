...
- **Tiny-Bert的多教师知识蒸馏**  
  Multi-Teacher: Bert-base&Roberta-base模型定义  
  Student-TinyBert模型定义  
  基于TextBrewer的蒸留实现  
  模型推理及性能对比
...
课程形式:录播定时更新(2023.5.17号必定更新结束!)

学生价格**149**元 非学生价: 169元
...
<img title="" src="https://user-images.githubusercontent.com/87959426/230844531-47881d30-9e6e-451a-b3b4-c8d9538b73bc.jpg" alt="关系抽取课表" width="700" >  
...
- **基于Prompt的文本分类逐行手写复现**<br>
  Prompt 格式的数据准备及读取<br>
  预训练模型构建<br>
  Prompt 中的loss 设计<br>
  基于 Prompt 准确率计算

- **基于 ptuning 的文本分类逐行手写复现**<br>
  离散模板与连续模板<br>
  基于软模板的 Prompt 设计<br>
  Prompt 中的loss 设计<br>
  添加词典外的特殊 Token<br>
...
- **意图识别模型构建** <br>
  什么是意图识别、需要构建多少种意图?<br>
  构建多种意图识别模型，并选择最佳模型

- **医疗实体识别模型构建**<br>
  使用主流模型方案:BERT+BILSTM 构建实体识别模型<br>
  加入多种训练策略:动态加载、动态替换、实体随机MASK等，提高NER F1值

- **实体纠错、实体消歧模型**<br>
  引入基于字编码的实体消歧模型，解决输入有误.<br>
  NER识别不准等问题。
