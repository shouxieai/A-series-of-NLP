...
<img title="" src="https://user-images.githubusercontent.com/87959426/227755091-40626d34-febc-437c-b09c-612ac1f0435e.jpg" alt="手写AI微信" width="242" data-align="center"><img title="" src="https://user-images.githubusercontent.com/87959426/230550414-4fbb717b-ad30-44b2-8e0e-649e83720047.jpg" alt="打赏" width="242" data-align="center">
...
课程形式:录播定时更新(2023.4.15号必定更新结束!)<br>
89.9(学生价格)<br>
99.9(非学生价格)<br>
免费(知识图谱、第二期NLP高级班学生)
...
- **数据处理**：  
  什么是三元组?实体、关系、属性?  
  结构化数据处理、  
  NEO4J连接、节点与关系创建、数据插入

- **模型架构搭建**：  
  导入NE04J的图数据怎么用?  
  NEO4J如何查询?
  意图识别与实体识别后，如何与查询语句建立连接?
...
- **医疗实体识别模型构建**
  使用主流模型方案:BERT+BILSTM 构建实体识别模型
  加入多种训练策略:动态加载、动态替换、实体随机MASK等，提高NER F1值

- **实体纠错、实体消歧模型**
  引入基于字编码的实体消歧模型，解决输入有误.
  NER识别不准等问题。
...
数据制作、标注策略、训练策略应有尽有~<br>布丁老师全程保驾护航<br>拒绝PPT与数学公式，全程手绘!<br>拒绝阅读代码，逐行手写复现!<br>布丁老师全天候答疑<br>学生价格：**499**，非学生价格：599<br>
...
- **BERT 两大任务** 逐行复现:<br>单词掩码策略、<br>相邻句预测
- **数据集制作** 逐行复现： <br>LOSS设计、<br>模型训练

学生价格149，非学生价格：199 私聊微信：shouxie_ai<br>私聊获取课程链接及代码，答疑群永久维护
...
价格**29.9**， 私聊微信：shouxie_ai<br>获取课程链接及代码，答疑群永久维护
...
价格29.9 私聊微信：shouxie_ai，<br>私聊获取课程链接及代码，答疑群永久维护
