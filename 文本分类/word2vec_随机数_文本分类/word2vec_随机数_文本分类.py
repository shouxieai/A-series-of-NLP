...
def test_file():
    ...
    test_dataset = OhDataset(test_texts, test_labels, word_2_index, index_2_embedding, max_len)
...
if __name__ == "__main__":
    ...
    train_dataset = OhDataset(train_texts, train_labels, word_2_index, index_2_embedding,max_len)
    train_dataloader = DataLoader(train_dataset,batch_size,shuffle=False)

    dev_dataset = OhDataset(dev_texts, dev_labels, word_2_index, index_2_embedding, max_len)
